...
class TestBasicAuth(BaseTest):
    def test_authentication_valid_credentials(self, driver, logs_for_tests):
        ...
        assert basic_auth_page.check_successful_login(), err_msg and logs_for_tests.error(err_msg)
        ...
        assert actuacl_header_text == expected_page_header, header_err_msg and logs_for_tests.error(header_err_msg)
        ...
        assert actuacl_login_msg_text == expected_successful_login_msg, \
            login_err_msg and logs_for_tests.error(login_err_msg)
